...
// import logoNonColorUrl from "../public/logo-gray.svg";
...
const Layout = (props) => {
							...
							<Link href="/">
								<a>
									<svg
										...
										// y="0px"
										viewBox="0 0 874 558"
										// style="enable-background:new 0 0 874 558;"
										// xml:space="preserve"
										// width="200"
										height="80"
									...
									>
										<path
											className="color0 colorPath"
											d="M183.86,247.98c1.22,0.16,1.42-0.54,1.71-1.04c14.42-24.17,36.75-31.99,63.43-30.24
	...
	c3.05-0.17,4.18,0.69,4.07,3.96C183.69,232.89,183.86,240.47,183.86,247.98z"
										...
										<path
											className="color0 colorPath"
											d="M18.44,347.54c9.98,0,9.98,0,12.94,9.26c6.88,21.52,20.39,31.88,43.07,33.51c12.87,0.92,25.42,0.53,37.13-5.7
	...
	c-21.73-10.73-32.82-28.69-35.3-52.44c-0.22-2.15,0.24-2.93,2.39-2.86C12.7,347.61,15.57,347.54,18.44,347.54z"
										/>
										<path
											className="color1 colorPath"
											d="M854.1,330.77c0.24,2.47-0.61,4.67-1.69,6.84c-28.2,56.6-73.23,91.21-135.73,101.44
	...
	c6.94-8.75,12.26-18.54,17.09-28.61c3.85-8.03,13.84-9.54,19.33-3.16C853.36,325.45,854.31,327.91,854.1,330.77z"
										/>
										<path
											className="color2 colorPath"
											d="M508.14,277.83c0,40.92-0.05,81.84,0.09,122.76c0.01,3.79-0.61,5.41-4.82,5.04c-4.74-0.42-9.55-0.2-14.33-0.05
	...
	C508.14,215.1,508.14,246.47,508.14,277.83z"
										...
										<path
											className="color2 colorPath"
											d="M458.14,304.27c0,32.16-0.08,64.33,0.1,96.49c0.03,4.54-1.34,5.4-6.54,4.71c-3.49-0.47-7.03-0.54-10.52-0.08
	...
	C458.14,293.76,458.14,299.01,458.14,304.27z"
										...
										<path
											className="color1 colorPath"
											d="M433.26,102.25c0-30.4,0.08-60.8-0.1-91.2c-0.02-4,0.99-5.22,4.98-4.94c5.07,0.36,10.2,0.31,15.28,0.01
	...
	c-4.9-0.4-9.89-0.36-14.8-0.01c-3.89,0.27-5.07-0.78-5.04-4.87C433.34,163.05,433.26,132.65,433.26,102.25z"
										/>
										<path
											className="color3 colorPath"
											d="M357.74,466.93c9.67-11.8,20.96-16.29,34.67-14.9c15.88,1.61,24.95,10.17,25.45,26.12
	...
	c-0.02-3.4,0.57-4.63,4.33-4.54c10.13,0.24,10.13,0.03,10.33,9.88C357.75,464.38,357.74,464.95,357.74,466.93z"
										...
										<path
											className="color3 colorPath"
											d="M239.51,513.5c-1.26,17.38-10.55,29.45-25.75,33.81c-18.01,5.17-34.25,0.12-44.22-13.73
	...
	c2.9-7.15,2.9-7.15,10.81-7.15C235.39,513.5,237.44,513.5,239.51,513.5z"
										/>
										<path
											className="color4 colorPath"
											d="M204.91,181.47c0.46-1.72-0.23-2.51-2.33-2.13c-4.73,0.86-6.12-1.78-6.1-6.07c0.09-14-0.01-28,0.05-42
	...
	c2.97-1.02,6.12-1.71,9.25-2.07c6.44-0.74,12.87-1.39,19.2-4.29C182.78,153.79,182.85,157.89,182.76,161.98z"
										...
										<path
											className="color3 colorPath"
											d="M438.99,499.52c0-9.7-0.09-19.4,0.06-29.1c0.04-2.7-0.33-3.84-3.51-3.82c-9.79,0.06-9.7-0.11-9.12-9.96
	...
	C438.87,518.92,438.99,509.22,438.99,499.52z"
										...
										<path
											className="color3 colorPath"
											d="M60.83,191.62c-3.81,0.1-7.58-0.02-11.36-0.81c-8.87-1.84-14.83-6.9-18.01-15.28c-1.18-3.1-3.39-7.29-1.21-9.35
	...
	c13.25,4.79,17.87,17.89,10.49,29.97c-4.89,8.01-12.5,11.42-21.45,12.39C65.31,191.83,63.06,191.62,60.83,191.62z"
										...
										<path
											className="color3 colorPath"
											d="M222.08,124.63c7.52-8.97,16.01-12.76,26.4-12.41c13.3,0.44,21.5,7.79,22.37,21.11
	...
	z"
										...
										<path
											className="color3 colorPath"
											d="M406.98,178.73c-6.95,9.78-15.79,13.06-26.61,12.14c-12.42-1.06-20.28-8.14-20.66-20.64
	...
	c0.02,23.09-0.01,46.17,0.05,69.26c0.01,2.02-0.53,2.65-2.65,2.77C407.51,189.47,407.51,189.56,406.98,178.73z"
										...
										<path
											className="color4 colorPath"
											d="M588.14,468.42c6.5-8.35,12.31-15.49,22.58-16.51c7.18-0.71,7.65-0.39,7.64,6.53c0,3.02,0.98,6.62-0.33,8.91
	...
	C588.15,465.26,588.14,466.3,588.14,468.42z"
										...
										<path
											className="color3 colorPath"
											d="M103.21,151.87c0-7.63-0.2-15.27,0.09-22.89c0.14-3.71-0.86-5.16-4.69-4.78c-1.77,0.18-4.69,1.06-5.27-0.65
	...
	C103.23,151.87,103.22,151.87,103.21,151.87z"
										...
										<path
											className="color4 colorPath"
											d="M20.3,151.92c0,11.12-0.1,22.23,0.07,33.35c0.04,2.85-0.55,3.77-3.6,3.76c-9.51-0.04-9.51,0.12-9.51-9.31
	...
	z"
										...
										<path
											className="color0 colorPath"
											d="M866.31,304.09c0.03,6.74-5.2,12.16-11.92,12.33c-6.77,0.17-12.61-5.48-12.63-12.23
	c-0.02-6.54,5.5-12.2,12.05-12.33C860.69,291.72,866.28,297.19,866.31,304.09z"
										/>
										<path
											className="color4 colorPath"
											d="M20.3,96.52c0,1.74,0.1,3.49-0.02,5.23c-0.19,2.63,1.23,6.77-0.66,7.56c-3.11,1.31-7.09,0.61-10.71,0.63
	...
	C20.3,83.43,20.3,83.43,20.3,96.52z"
										...
										<path
											className="color2 colorPath"
											d="M605.35,314.11c-25.95,0-51.9-0.08-77.85,0.09c-3.78,0.02-4.83-1.01-4.73-4.76
	...
	c-43.17-23.66-87.77,7.6-89.07,51.58c-0.12,4.16,0.73,5.68,5.33,5.6c17.82-0.3,35.65-0.12,53.47-0.12H654.08z"
										...
										<path
											className="color3 colorPath"
											d="M524.89,505c-10.04,0-20.07,0.09-30.11-0.06c-2.96-0.04-3.9,0.67-3.43,3.78c0.55,3.62,0.98,7.23,2.18,10.7
	...
	c-0.14,2.28,0.36,2.99,2.75,2.94c7.47-0.16,14.95-0.06,22.43-0.06C524.29,492.48,531.77,492.43,539.24,492.51z"
										...
										<path
											className="color3 colorPath"
											d="M295,505c-9.87,0-19.75,0.22-29.61-0.11c-4.02-0.13-4.61,1.42-3.91,4.67c0.53,2.48,0.89,5.01,1.55,7.45
	...
	c7.32-0.16,14.65-0.05,21.98-0.05C294.64,492.48,302.29,492.49,309.93,492.47z"
										...
										<path
											className="color4 colorPath"
											d="M295.89,180.24c-0.76,9.32-0.75,9.22-9.47,8.75c-2.18-0.12-2.6-0.83-2.6-2.8c0.05-32.63,0.06-65.26-0.02-97.89
